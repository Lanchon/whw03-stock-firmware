...
bring_wan_up() {
   ...
   ip -6 tunnel add ${DSLITE_TUNNEL_INTERFACE_NAME} mode ipip6 remote ${DSLITE_AFTR} local ${SYSEVENT_current_wan_ipv6address} encaplimit none dev ${SYSCFG_wan_physical_ifname} 

...
SERVICE_CUSTOM_EVENTS="\
                        subscriber::connected|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        origin::last_restart_time|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        mqttsub::wlansubdev|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        motion::slave_start_bot_scan|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        origin::start_bot_scanning|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        origin::add_bots|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        origin::remove_bots|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        slave_offline|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        wifi-status|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        motion::slave_restart|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        motion::master_restart|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        ...
                        TZ|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT \
                      "
#backhaul::status_data|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
#######################################################################
#             NOTHING MORE TO DO

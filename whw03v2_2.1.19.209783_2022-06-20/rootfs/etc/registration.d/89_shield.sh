...
SERVICE_CUSTOM_EVENTS="\
            wan-started|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
            lan-started|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
            shield::license_id_changed|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
            shield::subscription_status|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
            shield::config_changed|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
            shield::signature_file_changed|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
            shield::license_error|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
            shield::cron_retry|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
            TZ|$SERVICE_DEFAULT_HANDLER \
                      "

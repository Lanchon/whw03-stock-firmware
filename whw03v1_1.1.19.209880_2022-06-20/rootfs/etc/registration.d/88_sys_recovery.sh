...
# the two events below will trigger the service_sys_restore.sh script to be run
SERVICE_CUSTOM_EVENTS="\
                        sys_recovery::backup|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        sys_recovery::restore|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT;
                      "

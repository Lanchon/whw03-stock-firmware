...
SERVICE_CUSTOM_EVENTS="\
                        setup::presetup|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        lldp::reload_config|$SERVICE_DEFAULT_HANDLER|NULL|$TUPLE_FLAG_EVENT; \
                        lldp::root_accessible|$SERVICE_DEFAULT_HANDLER; \
                        lan_ipaddr|$SERVICE_DEFAULT_HANDLER; \
                        ipv4_wan_ipaddr|$SERVICE_DEFAULT_HANDLER; \
                        ETH::port_1_status|$SERVICE_DEFAULT_HANDLER; \
                        ETH::port_2_status|$SERVICE_DEFAULT_HANDLER; \
                        ETH::port_3_status|$SERVICE_DEFAULT_HANDLER; \
                        ETH::port_4_status|$SERVICE_DEFAULT_HANDLER; \
                        ETH::port_5_status|$SERVICE_DEFAULT_HANDLER; \
                        backhaul::status|$SERVICE_DEFAULT_HANDLER; \
                        master::ip|$SERVICE_DEFAULT_HANDLER; 
                      "
